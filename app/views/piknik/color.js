$(function() {
  ...
  function setColor() {
    ...
    $('#logo span').eq(0).css('color', 'hsl('+(h+108)%360+','+(100-s)+'%,'+(100-l)+'%)');
    $('#logo span').eq(1).css('color', 'hsl('+(h+118)%360+','+(100-s)+'%,'+(100-l)+'%)');
    $('#logo span').eq(2).css('color', 'hsl('+(h+128)%360+','+(100-s)+'%,'+(100-l)+'%)');
    $('#logo span').eq(3).css('color', 'hsl('+(h+138)%360+','+(100-s)+'%,'+(100-l)+'%)');
    $('#logo span').eq(4).css('color', 'hsl('+(h+148)%360+','+(100-s)+'%,'+(100-l)+'%)');
    $('#logo span').eq(5).css('color', 'hsl('+(h+158)%360+','+(100-s)+'%,'+(100-l)+'%)');
  ...
  $(window).click(function() {
    ...
    set = !set;
    if (set) {
      $('#color').removeClass('itsok');
    } else {
      $('#color').addClass('itsok');
    }
  });
